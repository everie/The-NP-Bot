...
public class TrackArtistTag extends AbstractCommand {
    ...
    public String getOutput() {
        ...
        try {
            ...
            String sig = getSignature(method, npArtist, key, npTags);
        ...
        return displayNick(nickInfo) + " tagged " + npArtist + " with: " + displayTags;
    }

    private String getSignature(String method, String a, String k, String tags) {
